...
import { PHONE_NUMBER, COMPANY_NAME, ADDRESS, LANDMARK, RATING_VAL, REVIEW_COUNT_STR } from '../constants';
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 pt-1 text-xs">
                ...
                <div className="flex items-center gap-2.5 text-gray-300">
                  ...
                  <a href={`tel:${PHONE_NUMBER.replace(/\D/g,'')}`} className="hover:text-white transition-colors font-bold">+91 {PHONE_NUMBER}</a>
                </div>
                <div className="flex items-center gap-2.5 text-gray-300">
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="flex gap-3 pt-2">
                  <a 
                    ...
                    className="bg-gray-900 p-2.5 rounded-xl hover:bg-[#1877F2] transition-all text-white border border-gray-800 hover:border-transparent flex-1 flex items-center justify-center gap-2 text-xs font-bold"
                  >
                    <Facebook size={16} />
                    <span>Facebook</span>
                  </a>
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="bg-gray-900 p-2.5 rounded-xl hover:bg-[#25D366] transition-all text-white border border-gray-800 hover:border-transparent flex-1 flex items-center justify-center gap-2 text-xs font-bold"
                  >
