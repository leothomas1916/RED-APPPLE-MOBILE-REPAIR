      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            Chat on WhatsApp
              ...
              <div className="p-10 md:w-3/5 bg-gray-50 flex items-center justify-center">
                 <div className="text-center w-full">
                    <div className="mb-6 inline-block p-4 bg-white rounded-full shadow-lg">
                       <Clock size={32} className="text-red-600" />
                    </div>
                    <h4 className="text-xl font-bold text-gray-900 mb-2">Walk-ins Welcome</h4>
                    <p className="text-gray-600 mb-6">Mon - Sat: 9:00 AM - 7:00 PM <br/> Sun: 10:00 AM - 5:00 PM</p>
                    <a href={`tel:${PHONE_NUMBER.replace(/\D/g,'')}`} className="inline-block w-full py-3 bg-red-600 text-white font-bold rounded-lg shadow-lg hover:bg-red-700 transition-colors">
                      Call to Book
                    </a>
                 </div>
              </div>
