...
import { ADDRESS, PHONE_NUMBER, INSTAGRAM_URL, FACEBOOK_URL, HASHTAG_PHONE, WHATSAPP_URL, PHONE_NUMBER_FORMATTED } from '../constants';
        ...
        <RevealOnScroll>
          <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
              <div className="flex flex-col md:flex-row">
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex gap-4 items-center group">
                        <div className="w-10 h-10 bg-red-600/10 rounded-full flex items-center justify-center group-hover:bg-red-600 transition-colors shrink-0">
                             <Phone className="text-red-500 group-hover:text-white flex-shrink-0 transition-colors" size={20} />
                        </div>
                        <div>
                             <p className="text-xs text-gray-400 font-semibold uppercase mb-0.5">Official Phone Hotline</p>
                             <a href={`tel:${PHONE_NUMBER.replace(/\D/g,'')}`} className="text-white text-lg font-bold hover:text-red-500 transition-colors block">
                               {PHONE_NUMBER_FORMATTED}
                             </a>
                        </div>
                      </div>

                      <div className="flex gap-4 items-center pt-6 border-t border-gray-800 mt-auto">
                        <a 
                          href={FACEBOOK_URL} 
                          target="_blank" 
                          ...
                          aria-label="Facebook"
                        >
                          <Facebook className="text-gray-400 group-hover:text-white transition-colors" size={20} />
                        </a>
                        <a 
                          href={INSTAGRAM_URL} 
                          target="_blank" 
                          rel="noopener noreferrer" 
                          className="group flex items-center justify-center w-10 h-10 rounded-full bg-gray-800 hover:bg-[#E4405F] transition-all duration-300"
                      ...
                      <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex gap-3 items-center bg-emerald-950/60 border border-emerald-800/80 p-3 rounded-xl group cursor-pointer mt-4 hover:bg-emerald-900/60 transition-all">
                        <div className="w-9 h-9 bg-emerald-600/20 text-emerald-400 rounded-lg flex items-center justify-center shrink-0">
                        ...
                        <div>
                          <span className="text-xs font-bold text-emerald-400 block">WhatsApp Direct Chat</span>
                          <span className="text-[11px] text-gray-300 font-semibold">{PHONE_NUMBER_FORMATTED}</span>
                        </div>
                      </a>
                    </div>
                  </div>
                ...
                <div className="w-full md:w-3/5 h-[300px] md:h-auto min-h-[300px] relative bg-gray-100">
                   <iframe 
